...
$(document).ready(function () {
    ...
    var dd = new Date();
    var monthh = dd.getMonth();
    var dayy = dd.getDate();
    var yearr = dd.getUTCFullYear();


    $("#txtFechaInicio").datepicker({

        maxDate: new Date(yearr, monthh, dayy)
    });
    ...
    tabladata = $('#tbCompras').DataTable({
        "ajax": {
            "url": $.MisUrls.url._ObtenerCompras + "?fechainicio=" + ObtenerFecha() + "&fechafin=" + ObtenerFecha() + "&idproveedor=0&idagencia=0",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            {
                "data": "oAgencia", render: function (data) {
                    return data.Nombre
                }
            },
