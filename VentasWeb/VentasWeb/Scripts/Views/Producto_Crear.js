...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            Nombre: "Debes completar los campos",
            Descripcion: "Debes completar los campos",
            CodigoValle: "Debes completar los campos",
            Serie: "Debes completar los campos",
            EstadoEquipo: "Debes completar los campos"
...
$("#txtEstadoEquipo").inputFilter(function (value) {
    return /^[a-zA-Z]*$/g.test(value);
});
$("#txtCodigoValle").inputFilter(function (value) {
    return /^-?\d*$/.test(value);
});
