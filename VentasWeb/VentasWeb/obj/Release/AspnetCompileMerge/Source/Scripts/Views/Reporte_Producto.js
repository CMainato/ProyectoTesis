...
$('#btnBuscar').on('click', function () {
    ...
    jQuery.ajax({
        url: $.MisUrls.url._ObtenerReporteProducto + "?idagencia=" + $("#cboTienda").val() + "&codigoproducto=" + $("#txtCodigoProducto").val(),
        type: "GET",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function printData() {
    ...
    newWin.document.write("<h3>Reporte de productos por agencia</h3>");
