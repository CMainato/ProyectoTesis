                    ...
                    using (XmlReader dr = cmd.ExecuteXmlReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            if (doc.Element("DETALLE_VENTA") != null)
                            {
                                ...
                                rptDetalleVenta.oAgencia = (from dato in doc.Element("DETALLE_VENTA").Elements("DETALLE_AGENCIA")
                                                           select new Agencia()
                                                           {
                                ...
                                rptDetalleVenta.oListaDetalleVenta = (from producto in doc.Element("DETALLE_VENTA").Element("DETALLE_PRODUCTO").Elements("PRODUCTO")
                                                                      select new DetalleVenta()
                                                                      {
                                                                          ...
                                                                          Serie = producto.Element("Serie").Value,
                                                                          CodigoValle = producto.Element("CodigoValle").Value,
                                                                          EstadoEquipo = producto.Element("EstadoEquipo").Value,
                                                                          Observacion = producto.Element("Observacion").Value
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        rptListaVenta.Add(new Venta()
                        {
                            ...
                            oCliente = new Cliente() { NumeroDocumento = dr["NumeroDocumento"].ToString(),
