                    ...
                    using (XmlReader dr = cmd.ExecuteXmlReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            if (doc.Element("Usuario") != null)
                            {
                                ...
                                rptUsuario.oAgencia = (from dato in doc.Element("Usuario").Elements("DetalleAgencia")
                                                      select new Agencia()
                                                      {
                                                          IdAgencia = int.Parse(dato.Element("IdAgencia").Value),
        ...
        public bool RegistrarUsuario(Usuario oUsuario)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("IdAgencia", oUsuario.IdAgencia);
